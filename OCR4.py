...
path_pdf = r'D:\Projects\Projects\Dell hackathon\OCR_V1\pdfs\invoice_10991966555(manipal fee).pdf'
...
pages = convert_from_path(path_pdf) #converts pdf into set of images
count = 0
